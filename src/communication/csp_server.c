...
static void iface_init(CSPInterface *interfaceConfig) {
  ...
  case CAN:
    //     error =
    //     csp_can_socketcan_open_and_add_interface(interfaceConfig->Device,
    //     "CAN", interfaceConfig->Node, 1000000, 0, &default_iface);
    //     default_iface->name = "CAN";
    //     break;
    csp_print("CAN interface not supported in this build.\n");
    exit(1);
    break;
