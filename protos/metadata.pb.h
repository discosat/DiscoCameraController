...
#ifndef GOOGLE_PROTOBUF_INCLUDED_protos_2fmetadata_2eproto
#define GOOGLE_PROTOBUF_INCLUDED_protos_2fmetadata_2eproto
...
#include <google/protobuf/port_def.inc>
#define PROTOBUF_INTERNAL_EXPORT_protos_2fmetadata_2eproto
...
struct TableStruct_protos_2fmetadata_2eproto {
...
extern const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_protos_2fmetadata_2eproto;
class Metadata;
...
class MetadataItem final :
 ...
 private:
  ...
  friend struct ::TableStruct_protos_2fmetadata_2eproto;
};
// -------------------------------------------------------------------
...
// string log = 10;
inline void Metadata::clear_log() {
  log_.ClearToEmpty();
}
inline const std::string& Metadata::log() const {
  // @@protoc_insertion_point(field_get:Metadata.log)
  return _internal_log();
}
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void Metadata::set_log(ArgT0&& arg0, ArgT... args) {
 
 log_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:Metadata.log)
}
inline std::string* Metadata::mutable_log() {
  std::string* _s = _internal_mutable_log();
  // @@protoc_insertion_point(field_mutable:Metadata.log)
  return _s;
}
inline const std::string& Metadata::_internal_log() const {
  return log_.Get();
}
inline void Metadata::_internal_set_log(const std::string& value) {
  
  log_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, value, GetArenaForAllocation());
}
inline std::string* Metadata::_internal_mutable_log() {
  
  return log_.Mutable(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, GetArenaForAllocation());
}
inline std::string* Metadata::release_log() {
  // @@protoc_insertion_point(field_release:Metadata.log)
  return log_.Release(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArenaForAllocation());
}
inline void Metadata::set_allocated_log(std::string* log) {
  if (log != nullptr) {
...
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  // @@protoc_insertion_point(field_set_allocated:Metadata.log)
}
...
#include <google/protobuf/port_undef.inc>
#endif  // GOOGLE_PROTOBUF_INCLUDED_GOOGLE_PROTOBUF_INCLUDED_protos_2fmetadata_2eproto
